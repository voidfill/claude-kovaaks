"""The four tests that matter: encodings, byte-exact writing, the ownership gate,
and cloning. Everything runs against fixtures in a temp directory, never the real
KovaaK's install."""
